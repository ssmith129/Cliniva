...
class NgxLoadingBar {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: NgxLoadingBar, deps: [{ token: LoadingBarService }], target: i0.ɵɵFactoryTarget.Component }); }
...
export { LOADING_BAR_CONFIG, LoadingBarComponent, LoadingBarModule, LoadingBarService, LoadingBarState, NgxLoadingBar, provideLoadingBar };
