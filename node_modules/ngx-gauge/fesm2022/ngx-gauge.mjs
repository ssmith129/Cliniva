...
import { Directive, Input, ContentChild, ViewChild, ViewEncapsulation, Component, NgModule } from '@angular/core';
...
class NgxGaugeAppend {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeAppend, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.1.0", type: NgxGaugeAppend, isStandalone: false, selector: "ngx-gauge-append", exportAs: ["ngxGaugeAppend"], ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeAppend, decorators: [{
            type: Directive,
            args: [{
...
class NgxGaugePrepend {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugePrepend, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.1.0", type: NgxGaugePrepend, isStandalone: false, selector: "ngx-gauge-prepend", exportAs: ["ngxGaugePrepend"], ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugePrepend, decorators: [{
            type: Directive,
            args: [{
...
class NgxGaugeValue {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeValue, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.1.0", type: NgxGaugeValue, isStandalone: false, selector: "ngx-gauge-value", exportAs: ["ngxGaugeValue"], ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeValue, decorators: [{
            type: Directive,
            args: [{
...
class NgxGaugeLabel {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeLabel, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.1.0", type: NgxGaugeLabel, isStandalone: false, selector: "ngx-gauge-label", exportAs: ["ngxGaugeLabel"], ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeLabel, decorators: [{
            type: Directive,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGauge, decorators: [{
            ...
            args: [{ selector: 'ngx-gauge', host: {
                    ...
                    }, encapsulation: ViewEncapsulation.None, standalone: false, template: "<div class=\"reading-block\" #reading [style.fontSize]=\"(size-(margin*2)) * 0.22 + 'px'\">\n  <!-- This block can not be indented correctly, because line breaks cause layout spacing, related problem: https://pt.stackoverflow.com/q/276760/2998 -->\n  <u class=\"reading-affix\">\n    @switch (_prependChild != null) {@case (true) {\n      <ng-content select=\"ngx-gauge-prepend\"></ng-content>\n      }@case (false) {\n      {{prepend}}\n      }}\n    </u>\n    @switch (_valueDisplayChild != null) {@case (true) {\n      <ng-content select=\"ngx-gauge-value\"></ng-content>\n      }@case (false) {\n      {{value | number}}\n      }}\n      <u class=\"reading-affix\">\n        @switch (_appendChild != null) {@case (true) {\n          <ng-content select=\"ngx-gauge-append\"></ng-content>\n          }@case (false) {\n          {{append}}\n          }}\n        </u>\n      </div>\n      <div class=\"reading-label\" #rLabel\n        [style.fontSize]=\"(size-(margin*2)) / 13 + 'px'\"\n        >\n        @switch (_labelChild != null) {\n          @case (true) {\n            <ng-content select=\"ngx-gauge-label\"></ng-content>\n          }\n          @case (false) {\n            {{label}}\n          }\n        }\n      </div>\n      <canvas #canvas></canvas>\n", styles: [".ngx-gauge-meter{display:inline-block;text-align:center;position:relative}.reading-block{position:absolute;width:100%;font-weight:400;white-space:nowrap;text-align:center;overflow:hidden;text-overflow:ellipsis}.reading-label{font-family:inherit;width:100%;display:inline-block;position:absolute;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-weight:400}.reading-affix{text-decoration:none;font-size:.6em;opacity:.8;font-weight:200;padding:0 .18em}.reading-affix:first-child{padding-left:0}.reading-affix:last-child{padding-right:0}\n"] }]
...
class NgxGaugeModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeModule, declarations: [NgxGauge, NgxGaugeAppend, NgxGaugePrepend, NgxGaugeValue, NgxGaugeLabel], imports: [CommonModule], exports: [NgxGauge, NgxGaugeAppend, NgxGaugePrepend, NgxGaugeValue, NgxGaugeLabel] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeModule, imports: [CommonModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: NgxGaugeModule, decorators: [{
            type: NgModule,
            args: [{
